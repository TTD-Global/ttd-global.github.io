import{_ as u,r as p,o as r,c,b as a,w as t,a as l,d as n,e as s}from"./app-5bf3c4c4.js";const k={},i=l(`<h2 id="booking-create-post" tabindex="-1"><a class="header-anchor" href="#booking-create-post" aria-hidden="true">#</a> Booking Create (POST)</h2><div class="language-curl" data-ext="curl"><pre class="language-curl"><code>https://dmc-uat-api.ttdthailand.com/api/clients/bookings
...
<span class="token punctuation">}</span>&#39;
  ...
  `),n("span",{class:"token property"},'"statusCode"'),n("span",{class:"token operator"},":"),s(),n("span",{class:"token number"},"201"),n("span",{class:"token punctuation"},","),s(`
  `),n("span",{class:"token property"},'"message"'),n("span",{class:"token operator"},":"),s(),n("span",{class:"token string"},'"success"'),s(`
...
Date                                    Tue, 13 Jun 2023 15:57:03 GMT
...
ETag                                    W/"26-800cvp1P4nkXkqLqII1vX+XIgL4"

X-Served-By                             dmc-uat-api.ttdthailand.com
`)])],-1);function d(y,m){const o=p("CodeGroupItem"),e=p("CodeGroup");return r(),c("div",null,[i,a(e,null,{default:t(()=>[a(o,{title:"Body"},{default:t(()=>[q]),_:1}),a(o,{title:"Headers (9)"},{default:t(()=>[g]),_:1})]),_:1})])}const f=u(k,[["render",d],["__file","bookingCreate.html.vue"]]);export{f as default};
